...
// alert('hello');
    ...
    var financeSummary = function() {
        var container = KTUtil.getByID('kt_chart_finance_summary');

        if (!container) {
            return;
        }

        var MONTHS = ['Mar 2019', 'APR 2019', 'Jun 2019', 'JUL 2019', 'AUG 2019', 'SEP 2019'];

        var color = Chart.helpers.color;
        var barChartData = {
            labels: ['Mar 2019', 'APR 2019', 'Jun 2019', 'JUL 2019', 'AUG 2019', 'SEP 2019'],
            datasets : [
                {
                    fill: true,
                    //borderWidth: 0,
                    ...
                    data: [10000, 12300, 15008, 14300, 25600, 13000, 30]
                }
            ]
        };
    ...
    var orderStatistics = function() {
        ...
        var MONTHS = ['sep 22', 'sep 21', 'sep 20', 'sep 19', 'sep 18', 'sep 17'];

        var color = Chart.helpers.color;
        var barChartData = {
            labels: ['sep 22', 'sep 21', 'sep 20', 'sep 19', 'sep 18', 'sep 17'],
            datasets : [
				{
                    fill: true,
                    //borderWidth: 0,
